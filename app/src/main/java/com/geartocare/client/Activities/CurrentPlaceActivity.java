...
import com.geartocare.client.databinding.ActivityCurrentPlaceBinding;
...
public class CurrentPlaceActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String apiKey = "AIzaSyAQtEk43RaJ2Jp-6EnqK2qXz58OuJZKZCE";
        Places.initialize(getApplicationContext(), apiKey);
        mPlacesClient = Places.createClient(this);
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(CurrentPlaceActivity.this);
    }
    ...
    private void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(CurrentPlaceActivity.this.getApplicationContext(),
